...
<link rel="stylesheet" href="{{url('/css/docProfile.css')}}">
<div class="container mt-4 mb-4 p-3 d-flex justify-content-center">
    <div class="card p-4">
        <div class=" image d-flex flex-column justify-content-center    align-items-center">
            <button class="btn btn-secondary">
                <img src="{{url('/uploads',$dogs->image)}}" height="100" width="100" />
            </button>
            <span class="name mt-3">{{$dogs->doctor_name}}</span>
            <span class="idd">{{$dogs->address}}</span>
